    ...
    public class PizzasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pizzas != null ? 
                          ...
                          Problem("Entity set 'PizzaContext.Pizzas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Price,PhotoPath")] Pizza pizza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Price,PhotoPath")] Pizza pizza)
        {
            if (id != pizza.Id)
            {
                return NotFound();
